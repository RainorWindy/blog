        ...
        <div class="bleft">
            <div class="sharebox sims">
                <div class="sharetitle simi">
                    <h3>当前位置:首页><?php echo $topcate; ?>><?php echo $cate; ?></h3>
                    <div class="contentbox">
                        <h4><?php echo $detail['title']; ?></h4>
                        <p class="isshortinfos"><small>发布时间: <?php echo date('Y-m-d',$detail['issuetime']); ?> 编辑：[ <a
                                ...
                                <span style="color:#1d89e8"><?php echo $cate; ?></span> ] 浏览次数：[ <span
                                    style="color:#1d89e8"><?php echo $detail['clicktime']; ?></span> ]</small></p>
                        <article>
                    ...
                    <div class="pre_and_next">
                        <p class="prea">上一篇:<?php if($prevone): ?><a
                                href="<?php echo url('/index/article/aprev',array('nid'=>$prevone['topcate_id'],'category_by'=>$prevone['cid'],'itemsid'=>$prevone['art_id'])); ?>"><?php echo $prevone['title']; ?></a><?php else: ?><span
                                class="" style="color: #666;margin-left: 5px;">无</span><?php endif; ?></p>
                        <p class="nexta">下一篇:<?php if($nextone): ?><a
                                href="<?php echo url('/index/article/aprev',array('nid'=>$nextone['topcate_id'],'category_by'=>$nextone['cid'],'itemsid'=>$nextone['art_id'])); ?>"><?php echo $nextone['title']; ?></a><?php else: ?><span
                                class="" style="color: #666;margin-left: 5px;">无</span><?php endif; ?></p>
                    </div>
                    <!-- 上一篇&&下一篇 -->
                </div>
            ...
            <div class="sharebox sims">
                <div class="sharetitle simi">
                    ...
                    <div class="relacontentbox">
                        ...
                        <p class="relalist"><a
                                href="<?php echo url('/index/article/aprev',array('nid'=>$rel['topcate_id'],'category_by'=>$rel['cid'],'itemsid'=>$rel['art_id'])); ?>"><?php echo $rel['title']; ?></a>
                        </p>
